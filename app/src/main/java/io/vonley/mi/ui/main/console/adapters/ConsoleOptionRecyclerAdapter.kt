...
import io.vonley.mi.extensions.getSocket
...
class ConsoleOptionRecyclerAdapter @Inject constructor(
...
) : RecyclerView.Adapter<ConsoleOptionRecyclerAdapter.ConsoleOptionViewHolder>() {

    private var consoles = emptyList<Console>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ConsoleOptionViewHolder {
        return ConsoleOptionViewHolder(
    ...
    override fun onBindViewHolder(holder: ConsoleOptionViewHolder, position: Int) {
    ...
    inner class ConsoleOptionViewHolder(val binding: VhConsoleOptionBinding) :
